...
String SendHTMLConfigurarRelogio(){
  ...
  buf += "                <button>confirmar</button>";
  buf += "                <button id='cancel-button'>cancelar</button>";
  buf += "            </div>";
  buf += "        </div>";
  buf += "    </div>";
  buf += "</body>";
...
void callbackParaConfigurarRelogio(){
...
void setup() {
	...
	server.on("/configurar-relogio", callbackParaConfigurarRelogio);
	server.on("/liga", liga);
